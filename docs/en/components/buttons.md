...
<div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;margin:24px 0;">
  <span style="display:inline-flex;align-items:center;justify-content:center;padding:12px 24px;border-radius:10px;font-weight:600;font-size:0.875rem;background:var(--bg-orange-500);color:white;cursor:pointer;">Primary</span>
  ...
  <span style="display:inline-flex;align-items:center;justify-content:center;padding:12px 24px;border-radius:10px;font-weight:600;font-size:0.875rem;background:transparent;color:var(--bg-orange-700);border:2px solid #FF8500;cursor:pointer;">Outline</span>
...
<div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;margin:24px 0;">
  <span style="display:inline-flex;align-items:center;justify-content:center;padding:8px 16px;border-radius:8px;font-weight:600;font-size:13px;background:var(--bg-orange-500);color:white;">Small</span>
  <span style="display:inline-flex;align-items:center;justify-content:center;padding:12px 24px;border-radius:10px;font-weight:600;font-size:14px;background:var(--bg-orange-500);color:white;">Default</span>
  <span style="display:inline-flex;align-items:center;justify-content:center;padding:16px 32px;border-radius:12px;font-weight:600;font-size:16px;background:var(--bg-orange-500);color:white;">Large</span>
</div>
...
<div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;margin:24px 0;">
  <span style="display:inline-flex;align-items:center;justify-content:center;padding:12px 24px;border-radius:10px;font-weight:600;font-size:0.875rem;background:var(--bg-orange-200);color:white;cursor:not-allowed;opacity:0.7;">Primary Disabled</span>
