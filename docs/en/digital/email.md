...
| Usage | Color | Hex |
|-------|-------|-----|
| Accent line | <span style="color:var(--bg-orange-500)">■</span> BAUER Orange | `#FF8500` |
| Links (email, web, booking) | <span style="color:var(--bg-orange-700)">■</span> Dark Orange | `#C2570A` |
