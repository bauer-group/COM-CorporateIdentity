...
<div style="display:flex;flex-direction:column;gap:8px;background:white;padding:24px;border:1px solid #E0DBD6;border-radius:12px;margin:24px 0;">
  ...
  <div style="color:var(--bg-warm-600);font-size:1.05em;">Lead text with a bit more context (text-secondary).</div>
  <div style="color:var(--bg-warm-500);font-size:0.85em;">Caption with metadata · 2026-05-06 · 3 min read (text-muted)</div>
  <div style="color:var(--bg-warm-400);font-size:0.95em;">Disabled button text or placeholder (text-disabled)</div>
</div>
...
<div style="border-radius:12px;overflow:hidden;border:1px solid #E0DBD6;margin:24px 0;">
  ...
  <div style="background:var(--bg-brand-light);padding:20px;border-bottom:1px solid #E0DBD6;">
    ...
    <div style="color:var(--bg-warm-600);font-size:0.85em;">Card background, hover states, secondary sections</div>
  </div>
  <div style="background:var(--bg-warm-100);padding:20px;">
    <div style="color:var(--bg-brand-dark);font-weight:600;">bg-muted (Warm 100)</div>
    <div style="color:var(--bg-warm-600);font-size:0.85em;">Tertiary surfaces, code blocks, recessed areas</div>
  </div>
</div>
...
<div style="display:flex;gap:16px;flex-wrap:wrap;margin:24px 0;">
  <div style="flex:1;min-width:200px;background:white;border:1px solid #E0DBD6;border-radius:8px;padding:20px;">
    ...
    <div style="color:var(--bg-warm-600);font-size:0.85em;">border (Warm 200) — the standard hairline</div>
  </div>
  <div style="flex:1;min-width:200px;background:white;border:1.5px solid #C4BDB7;border-radius:8px;padding:20px;">
    <div style="color:var(--bg-brand-dark);font-weight:600;margin-bottom:6px;">Active card</div>
    <div style="color:var(--bg-warm-600);font-size:0.85em;">border-strong (Warm 300) — emphasized separation</div>
  </div>
</div>
