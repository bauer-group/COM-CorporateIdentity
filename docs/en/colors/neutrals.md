...
<div style="border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.1);margin:24px 0;">
  <div style="background:#FFFFFF;padding:24px 20px;">
    <div style="color:#3A3430;font-weight:700;margin-bottom:4px;">Primary content</div>
    <div style="color:#6B635C;font-size:0.85em;">Brand White (#FFFFFF) as the standard background</div>
  </div>
  <div style="background:#F9F8F6;padding:24px 20px;">
    <div style="color:#3A3430;font-weight:700;margin-bottom:4px;">Secondary section</div>
    <div style="color:#6B635C;font-size:0.85em;">Brand Light (#F9F8F6) — warm background for visual separation</div>
  </div>
  <div style="background:#3A3430;padding:24px 20px;">
    <div style="color:#FFFFFF;font-weight:700;margin-bottom:4px;">Dark section</div>
    <div style="color:#C4BDB7;font-size:0.85em;">Brand Dark (#3A3430) for contrast and depth</div>
  </div>
  <div style="background:#231F1C;padding:24px 20px;">
    <div style="color:#FFFFFF;font-weight:700;margin-bottom:4px;">Footer area</div>
    <div style="color:#A69E97;font-size:0.85em;">Brand Black (#231F1C) for deep regions</div>
  </div>
</div>
